...
@Component({
  selector: 'app-tag-admin-side',
  templateUrl: './tag-admin-side.component.html',
  styleUrls: ['./tag-admin-side.component.css']
})
export class TagAdminSideComponent implements OnInit {
